...
/**
 * Version 2 of <b>FindContactMessageHandler</b>. This version expects a message in form contactId!contactName and
 * invokes getContactByIdAndName()
 * 
...
public class FindContactMessageHandler implements MessageHandler {
  ...
  public Object handleMessage(String message) {
    ...
    Activator.log("Find Contact with Id '%s' and name '%s'", findContactMessage.getContactId(),
        findContactMessage.getName());
    Contact contact = contactService.getContactByIdAndName(findContactMessage.getContactId(),
        findContactMessage.getName());
